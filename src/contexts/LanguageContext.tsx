...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // More Games
    "more.games": "Faith Games",

    // Games
    "games.title": "Faith Games",
    "games.subtitle": "Test your knowledge and have fun!",
    ...
    "games.wrong": "Wrong! The answer was:",
    "games.clues": "Clues",
    "games.question": "Question",
    "games.playAgain": "Play Again",
    "games.quizComplete": "Quiz Complete!",
    "games.correctAnswers": "correct answers",
    "games.seeResults": "See Results",
    "games.truth": "Catholic Truth",
    "games.heresy": "Heresy",
    "games.hint": "Hint",
    "games.tapWords": "Tap the words in the correct order",
    "games.tryAgain": "That's not right. Try again!",
    "games.saints": "Saints",
    "games.patrons": "Patron Of",
    "games.matchInstructions": "Select a saint, then tap their patronage to match",
    "games.allMatched": "All matched!",
    "games.nextRound": "Next Round",
    "games.guessSaint": "Guess the Saint",
    "games.guessSaint.desc": "Read the clues and identify the saint",
    "games.bibleQuiz": "Bible Quiz",
    "games.bibleQuiz.desc": "Test your Scripture knowledge",
    "games.truthHeresy": "Truth vs Heresy",
    "games.truthHeresy.desc": "Can you tell truth from error?",
    "games.wordScramble": "Word of God Scramble",
  ...
  ar: {
    ...
    "home.saintOfTheDay": "قديس اليوم",
    "home.saint.patron": "شفيع",
    ...
    "link.heresies": "البدع",
    "link.social": "اجتماعي",
    "link.prayers": "الصلوات",
    "prayers.title": "الصلوات",
    "prayers.subtitle": "كنز من الصلوات الكاثوليكية",
    "prayers.count": "صلاة",
    "prayers.empty": "لا توجد صلوات في هذه الفئة بعد.",
    "prayers.notFound": "الصلاة غير موجودة.",
    "prayers.back": "العودة إلى الفئة",
    "prayers.cat.marian": "العذراء مريم",
    "prayers.cat.holySpirit": "الروح القدس",
    "prayers.cat.rosary": "المسبحة الوردية",
    "prayers.cat.saints": "صلوات القديسين",
    "prayers.cat.morningEvening": "الصباح والمساء",
    "prayers.cat.eucharistic": "الإفخارستيا",
    "prayers.cat.general": "التقليدية",
    ...
    // More Games
    "more.games": "ألعاب الإيمان",

    // Games
    "games.title": "ألعاب الإيمان",
    "games.subtitle": "اختبر معلوماتك واستمتع!",
    ...
    "games.correct": "صحيح!",
    "games.incorrect": "خطأ",
    "games.wrong": "خطأ! الإجابة الصحيحة:",
    "games.clues": "أدلّة",
    "games.question": "سؤال",
    "games.playAgain": "العب مجددًا",
    "games.quizComplete": "اكتمل الاختبار!",
    "games.correctAnswers": "إجابة صحيحة",
    "games.seeResults": "عرض النتائج",
    "games.truth": "تعليم كاثوليكي",
    "games.heresy": "بدعة",
    "games.hint": "تلميح",
    "games.tapWords": "اضغط على الكلمات بالترتيب الصحيح",
    "games.tryAgain": "ليس صحيحًا. حاول مجددًا!",
    "games.saints": "القديسون",
    "games.patrons": "شفيع",
    "games.matchInstructions": "اختر قديسًا ثم اضغط على شفاعته لتطابقها",
    "games.allMatched": "تمّت المطابقة!",
    "games.nextRound": "الجولة التالية",
    "games.guessSaint": "خمّن القديس",
    "games.guessSaint.desc": "اقرأ الأدلّة وحدّد القديس",
    "games.bibleQuiz": "اختبار الكتاب المقدس",
    "games.bibleQuiz.desc": "اختبر معرفتك بالكتاب المقدس",
    "games.truthHeresy": "حقيقة أم بدعة",
    "games.truthHeresy.desc": "هل تستطيع تمييز الحقيقة من الخطأ؟",
    "games.wordScramble": "رتّب كلمة الله",
